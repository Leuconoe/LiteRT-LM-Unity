...
namespace LiteRTLM.Unity
{
    ...
    public sealed class LiteRtLmSceneNavigator : MonoBehaviour
    {
        ...
        {
            // Interactive scenes (Test Scenes sample)
            "LiteRtLmSampleScene",
            ...
            // Automated scenes (Automated Tests sample) — included so the whole
            // set can be walked through; skipped automatically when that sample
            // is not imported or the scene is absent from Build Settings.

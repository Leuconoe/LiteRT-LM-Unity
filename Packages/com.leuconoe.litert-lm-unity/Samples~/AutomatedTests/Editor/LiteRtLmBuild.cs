...
namespace LiteRTLM.Unity.Editor
{
    public static class LiteRtLmBuild
    {
        ...
        [MenuItem("LiteRT-LM/Build/Android/AVD Smoke APK")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/gemma-4-E2B-it")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke APK/Gemma 4 E2B IT GPU No Speculative")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke APK/Gemma 4 E2B IT CPU")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/gemma3-1b-it-int4")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/gemma3-1b-it-int4 CPU")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/gemma3-270m-it-q8")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/mobile_actions_q8_ekv1024")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/Qwen3-0.6B")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/Qwen2.5-0.5B-Instruct")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/Qwen2.5-0.5B-Instruct CPU")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/Qwen2.5-1.5B-Instruct")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build AVD Smoke Test APK/Qwen2.5-1.5B-Instruct CPU")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build ASR Smoke Test APK/Parakeet TFLite Inspect")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build LLM Chat Test APK")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build ASR Test APK")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build ASR Function Calling Test APK")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build Multimodal Function Calling Test APK")]
        ...
        [MenuItem("LiteRT-LM/Build/Android/Build Translate Test APK")]
        ...
        [MenuItem("LiteRT-LM/Windows/Run Windows Editor Self-Test")]
        ...
        [MenuItem("LiteRT-LM/Windows/Run Windows Conversation Scene Test")]
        ...
        [MenuItem("LiteRT-LM/Windows/Run Windows Function Calling Benchmark")]
        ...
        [MenuItem("LiteRT-LM/Windows/Run Windows Function Calling Benchmark", true)]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma-4-E2B-it")]
        public static void RunWindowsFunctionCallingBenchmarkGemma4()
        {
            StartWindowsFunctionCallingBenchmarkInBackground(FunctionCallingGemma4ModelPath);
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma-4-E2B-it", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkGemma4()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-1b-it-int4")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-1b-it-int4", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkGemma1B()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-1b-it-int4 Unconstrained")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-1b-it-int4 Unconstrained", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkGemma1BUnconstrained()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-270m-it-q8")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-270m-it-q8", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkGemma270M()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-270m-it-q8 Unconstrained")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-270m-it-q8 Unconstrained", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkGemma270MUnconstrained()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-270m-it-q8 Compact Unconstrained")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run gemma3-270m-it-q8 Compact Unconstrained", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkGemma270MCompactUnconstrained()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run Qwen3-0.6B")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run Qwen3-0.6B", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkQwen3()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run Qwen3-0.6B Unconstrained")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run Qwen3-0.6B Unconstrained", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkQwen3Unconstrained()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run mobile_actions_q8_ekv1024")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run mobile_actions_q8_ekv1024", true)]
        public static bool CanRunWindowsFunctionCallingBenchmarkMobileActions()
        {
            return CanRunWindowsFunctionCallingBenchmark();
        }

        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run mobile_actions_q8_ekv1024 Unconstrained")]
        ...
        [MenuItem("LiteRT-LM/Benchmarks/Function Calling/Run mobile_actions_q8_ekv1024 Unconstrained", true)]
        ...
        /// <summary>
        /// Runs <paramref name="buildAction"/> with only <paramref name="allowedEntries"/>
        /// left in StreamingAssets. Exposed so other build entry points (the TTS
        /// smoke APK) can reuse the stash/restore logic instead of copying it —
        /// this project's StreamingAssets holds multi-GB models, and packaging all
        /// of them yields an APK that cannot be installed.
        ///
        /// An entry may be a single file or a whole subfolder ("TTS/supertonic-litert").
        /// </summary>
        public static void BuildWithSelectedStreamingAssets(
            HashSet<string> allowedEntries, Action buildAction)
        {
            WithAndroidSelectedStreamingAssets(allowedEntries, buildAction);
        }

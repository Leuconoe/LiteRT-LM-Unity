...
0.5B worked on CPU. Qwen3 0.6B and smaller Gemma/mobile-action models could
start, but smoke output quality was poor for the generic smoke prompt.
...
| `Qwen2.5-0.5B-Instruct-q8` | `LiteRtLmAndroidSmokeTest-Qwen2.5-0.5B-Instruct-CPU.apk` | CPU | PASS | CPU | 2.010s | 0.848s | 0.279s | N/A | N/A | N/A | N/A | N/A | Not measured on Android smoke | Best verified Qwen2.5 path on the older physical-device run. |
...
2. Keep `Qwen2.5-0.5B-Instruct-q8` as a CPU fallback reference.
